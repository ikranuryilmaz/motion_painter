...
#
# Script generated by Vivado on Sat Apr 27 17:41:49 +0300 2024
...
# script info
echo -e "FrameBuffer.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FrameBuffer xil_defaultlib.FrameBuffer xil_defaultlib.glbl -log elaborate.log
}
