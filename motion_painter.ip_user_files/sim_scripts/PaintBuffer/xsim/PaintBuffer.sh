...
#
# Script generated by Vivado on Sat Apr 27 22:35:32 +0300 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : PaintBuffer.sh
...
#
# Usage        : PaintBuffer.sh
#                PaintBuffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PaintBuffer.sh [-reset_run]
#                PaintBuffer.sh [-reset_log]
#                PaintBuffer.sh [-help]
#
...
# script info
echo -e "PaintBuffer.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PaintBuffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PaintBuffer xil_defaultlib.PaintBuffer xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PaintBuffer -key {Behavioral:sim_1:Functional:PaintBuffer} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PaintBuffer.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PaintBuffer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PaintBuffer.sh [-help]\n\
Usage: PaintBuffer.sh [-step]\n\
Usage: PaintBuffer.sh [-lib_map_path]\n\
Usage: PaintBuffer.sh [-reset_run]\n\
Usage: PaintBuffer.sh [-reset_log]\n\
Usage: PaintBuffer.sh [-keep_index]\n\
Usage: PaintBuffer.sh [-noclean_files]\n\n\
